...
export const Cookies: FC<CookiesProps> = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col sm:flex-row items-center bg-white px-3 py-2.5 space-y-2 sm:space-y-0 sm:space-x-3 border border-dark/10 rounded-3xl sm:rounded-full">
